import{c as s,S as n,j as p,m as e}from"./chunks/framework.BAaBdyf2.js";const _=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"examples/osmmakie.md","filePath":"examples/osmmakie.md","lastUpdated":null}'),l={name:"examples/osmmakie.md"};function i(o,a,t,r,c,d){return n(),p("div",null,[...a[0]||(a[0]=[e(`<h2 id="OpenStreetMap-data-OSM" tabindex="-1">OpenStreetMap data (OSM) <a class="header-anchor" href="#OpenStreetMap-data-OSM" aria-label="Permalink to &quot;OpenStreetMap data (OSM) {#OpenStreetMap-data-OSM}&quot;">​</a></h2><p>In this example, we combine OpenStreetMap data, loading some roads and buildings and plotting them on top of a Tyler map.</p><div class="language-@example vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">@example</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>using Tyler, Tyler.TileProviders</span></span>
